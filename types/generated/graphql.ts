...
export type UserLanguage = {
  ...
  color: Scalars['String']['output'];
  name: Scalars['String']['output'];
  rank?: Maybe<RankLanguage>;
  score: Scalars['Int']['output'];
  size: Scalars['Float']['output'];
  tiers?: Maybe<RankTier>;
};
